...
const PROTECTED_ROUTES = [
  ...
  "app/api/dashboard/knowledge/route.ts",
  "app/api/dashboard/knowledge/[id]/route.ts",
  "app/api/dashboard/knowledge/[id]/intelligence/route.ts",
  "app/api/dashboard/knowledge/categories/route.ts",
  "app/api/dashboard/knowledge/categories/[id]/route.ts",
  "app/api/dashboard/knowledge/groups/route.ts",
  "app/api/dashboard/knowledge/groups/[id]/route.ts",
