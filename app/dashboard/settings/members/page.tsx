...
import { Users, UserPlus, Crown, Shield, User, Eye, MoreHorizontal, Trash2, Building2 } from "lucide-react"
...
export default function MemberManagementPage() {
  ...
  const canManageMember = (member: OrganizationMember) => {
    ...
    // Admin can manage members and viewers, but not owner or other admins
