...
export const tr: Dict = {
  ...
  'chat.amrCard.switchBody': 'RantAI Design\'ın resmi AMR model hizmetine geçin — API anahtarı yapılandırması gerekmez. Oturum açma, yetkilendirme ve bakiye yükleme sonrası bu çalıştırma otomatik olarak yeniden denenir.',
  ...
  'chat.runError.signInMessage.amr': 'RantAI Design aracısı henüz oturum açmadı — kullanmaya başlamak için oturum açın.',
  'chat.runError.signInMessage.other': '{agent} oturum açmadı. Oturum durumunu yerel olarak kontrol edin. Daha kararlı ve hesaplı RantAI Design aracısını öneririz.',
  ...
  'settings.welcomeTitle': 'RantAI Design’a hoş geldiniz',
  'settings.welcomeSubtitle': '',
  'settings.onboardingCreateTitle': 'Bir brief ile başlayın',
  'settings.onboardingCreateBody': 'İstediğiniz siteyi, uygulamayı, sunumu, görseli veya videoyu tanımlayın. RantAI Design bir proje oluşturacak ve çalışmayı düzenlenebilir tutacak.',
  ...
  'settings.onboardingMemoryCalloutBody': 'Bu yanıtlar Bellek profilinizin temelini oluşturur. RantAI Design bunu her görevde yeniden kullanır ve siz çalışırken öğrenmeye devam eder.',
  ...
  'settings.onboardingCloudTitle': 'RantAI Design’a giriş yap',
  'settings.onboardingCloudBody': 'Giriş yap ve bulut yapay zekâsıyla hemen tasarlamaya başla — karmaşık kurulum gerekmez.',
  'settings.onboardingCloudSignIn': 'RantAI Design Cloud’a giriş yap',
  ...
  'settings.onboardingGateTooltipAmr': 'Sonraki adımlar yapay zekâ ile çalışır — devam etmek için RantAI Design AMR’ye giriş yapın.',
  ...
  'settings.agentInstall.pathHint': 'Bir CLI\'yi npm veya Homebrew ile kurduysan ancak hâlâ kurulu değil olarak görünüyorsa, aracın bin dizininin RantAI Design daemon\'unun devraldığı PATH içinde olduğundan emin ol (macOS\'te Terminal ve GUI uygulamalarının PATH\'i farklı olabilir). QUICKSTART.md içindeki "Local agent CLI and PATH" bölümüne bak.',
  'settings.agentInstall.stepOpenLinks': 'Tercih ettiğin ajan için Yükle veya Dokümanlar bağlantısını aç.',
  'settings.agentInstall.stepAuth': 'RantAI Design\'a dönmeden önce sağlayıcı CLI\'sinde kimlik doğrulaması yap (oturum aç veya API kimlik bilgileri ekle).',
  ...
  'settings.mcpServerHint': 'RantAI Design\'ı kodlama ajanınız için MCP sunucusu olarak yayınlayın.',
  ...
  'settings.privacyHint': 'RantAI Design ekibiyle hangi veriler paylaşılır',
  'settings.privacyConsentKicker': 'RantAI Design\'ı geliştirmemize yardımcı olun',
  'settings.privacyConsentLead': 'RantAI Design, geliştirmemize yardımcı olmak için kullanım verilerini ekibimizle paylaşabilir. Buna şunlar dahildir:',
  ...
  'settings.mcpHint': 'Kodlama agent\'larının (Cursor, Claude Code, VS Code…) RantAI Design projelerinizi doğrudan okumasına izin verin.',
  'settings.mcpDaemonError': 'Kurulum yollarını çözümlemek için yerel daemon\'a ulaşılamadı ({error}). RantAI Design\'ın çalıştığından emin olun, ardından bu paneli yeniden açın.',
  ...
  'settings.mcpCapabilityDefault': 'RantAI Design\'da açık olan projeyi ve dosyayı varsayılan olarak kullanın; böylece hangi tasarım olduğunu yeniden belirtmeden "bunu uygulamamda oluştur" diyebilirsiniz.',
  'settings.mcpRunningNote': 'MCP araç çağrılarının başarılı olması için RantAI Design\'ın çalışıyor olması gerekir. Kodlama agent\'ınızı RantAI Design\'ı açmadan önce başlattıysanız, canlı daemon\'a ulaşabilmesi için agent\'ı yeniden başlatın.',
  ...
  'entry.discordAria': 'RantAI Design Discord\'una katılın',
  'entry.discordAriaWithOnline': 'RantAI Design Discord\'una katılın - {online}',
  'entry.discordOnlineLabel': '{count} çevrimiçi',
  'entry.followXLabel': 'X\'te RantAI Design hesabını takip et',
  ...
  'homeHero.chip.createPluginHint': 'Yeniden kullanılabilir bir RantAI Design plugin\'i oluşturun ve Plugin\'lerim\'e ekleyin.',
  ...
  'handoff.promptIntro': 'Bu yerel RantAI Design proje klasöründen devam edin:',
  ...
  'pluginsHome.subtitle': 'Bu çalışma zamanıyla birlikte gelen, kullanıma hazır RantAI Design iş akışları. Başlangıç istemi yüklemek için birini seçin veya daha fazlası için kayıt defterine göz atın.',
  ...
  'pluginsHome.emptyCatalog': 'Katalog boş. Paketlenmiş eklentiler RantAI Design ile birlikte gelir ve buraya otomatik olarak görünmelidir — bu durum devam ederse daemon\'u yeniden başlatmayı deneyin.',
  ...
  'pluginCard.contributeAria': '{title} öğesini RantAI Design\'a katkı olarak ekle',
  'pluginCard.contributeTitle': 'Plugin\'i pull request ile RantAI Design\'a katkı olarak ekle',
  ...
  'integrations.lede': 'Harici sistemleri bağlayın, MCP araçlarını agent döngünüze dahil edin ve RantAI Design\'ı diğer IDE\'ler, betikler ve otomasyonlardan kullanın.',
  ...
  'mcpClient.daemonError': 'Yerel daemon\'a ulaşılamadı. RantAI Design\'ın çalıştığından emin olun, ardından bu paneli yeniden açın.',
  'mcpClient.saveFailed': 'Kaydetme başarısız oldu. Daemon\'ın çalıştığını kontrol edip tekrar deneyin.',
  'useEverywhere.modalAria': 'RantAI Design\'ı her yerde kullanın',
  'useEverywhere.modalTitle': 'RantAI Design\'ı her yerde kullanın',
  'useEverywhere.modalSubtitle': 'RantAI Design\'ı herhangi bir IDE\'ye, Agent\'a veya betiğe bırakın — CLI, HTTP, MCP ve Beceriler. Her şeyi kurmak için "Bir agent için kılavuzu kopyala"yı kullanın ve Claude Code, Codex, Cursor, openclaw veya hermes\'e yapıştırın.',
  ...
  'useEverywhere.section.overview.heading': 'RantAI Design, agent\'ınızın çalıştığı her yerde çalışır',
  'useEverywhere.section.overview.intro': 'RantAI Design bir pencereden fazlasıdır — yerel ayrıcalıklı bir daemon (`od`) ile birlikte bir Beceriler + Tasarım Sistemleri + Atoms kayıt defteridir. Makinenizde çalışmaya başladığında, herhangi bir kod agent\'ı (Claude Code, Codex, Cursor, OpenCode/openclaw, Hermes, kendi betiğiniz) dört değiştirilebilir yüzey aracılığıyla üretimleri yönetebilir, projeleri inceleyebilir ve tasarım çıktıları üretebilir.',
  'useEverywhere.section.overview.bullet1': 'CLI — başsız betikler, CI ve kabuk otomasyonu için `od <command>`.',
  'useEverywhere.section.overview.bullet2': 'MCP sunucusu — RantAI Design\'ı bir Model Context Protocol sunucusu olarak bağlar, böylece MCP destekli herhangi bir agent becerileri listeleyebilir, senaryoları çalıştırabilir ve çıktıları okuyabilir.',
  ...
  'useEverywhere.section.overview.bullet4': 'Beceriler — PATH\'inizde zaten bulunan herhangi bir agent\'ın RantAI Design olmadan çağırabileceği eklenebilir `SKILL.md` paketleri (Claude uyumlu).',
  ...
  'useEverywhere.section.cli.heading': 'RantAI Design\'ı herhangi bir kabuktan yönetin',
  ...
  'useEverywhere.section.mcp.heading': 'RantAI Design\'ı herhangi bir kodlama agent\'ına MCP sunucusu olarak sun',
  'useEverywhere.section.mcp.intro': 'RantAI Design, MCP destekli herhangi bir istemcinin — Cursor, Claude Code, Antigravity, VS Code Copilot Chat, openclaw, hermes — RantAI Design araçlarını (becerileri listele, önizlemeleri oluştur, medya üret, eklentileri çalıştır) manuel olarak kabuk açmadan keşfetmesini sağlayan bir Model Context Protocol sunucusu (`od mcp`) ile gelir. Daemon, her büyük istemci için `GET /api/mcp/install-info` aracılığıyla yapıştırmaya hazır bir kurulum parçacığı yayınlar.',
  ...
  'useEverywhere.section.mcp.footer': 'RantAI Design uygulamasında, JSON\'u elle düzenlemek yerine istemciye özel bir kurulum komutu (Cursor, Claude Code, Antigravity, VS Code) kopyalamak için Ayarlar → Entegrasyonlar\'ı açın.',
  ...
  'useEverywhere.section.skills.heading': 'Herhangi bir agent için eklenebilir Beceriler — RantAI Design çalışmıyor olsa bile',
  'useEverywhere.section.skills.intro': 'Bir Beceri, Claude uyumlu bir `SKILL.md` (YAML ön bilgisi + gövde) içeren bir dizindir. RantAI Design, formatı `od:` ad alanıyla (`mode`, `preview`, `design_system`, `inputs`, …) genişletir, böylece aynı çıktı hem RantAI Design içinde hem de Claude Code, Codex, openclaw veya hermes gibi sade bir agent tarafından kullanılabilir. Keşif, projelerin kendi becerilerini geçersiz kılabilmesi için bir öncelik zincirini izler.',
  ...
  'useEverywhere.section.skills.snippet1': 'Minimal SKILL.md (Claude uyumlu ön bilgi + RantAI Design ekstraları)',
  ...
  'entry.githubStarAria': 'RantAI Design’a GitHub üzerinde yıldız ver',
  ...
  'newproj.locationDefault': 'RantAI Design projeleri',
  ...
  'socialShare.openDesignSection': 'RantAI Design\'ı paylaş',
  'socialShare.openDesignTitle': 'GitHub\'da RantAI Design',
  'socialShare.openDesignText': 'RantAI Design; tasarım yapıtları oluşturmak, düzenlemek, dağıtmak ve devretmek için açık kaynaklı bir çalışma alanıdır.',
  ...
  'socialShare.projectText': 'RantAI Design ile oluşturuldu: {title}. Dağıtılan yapıtı görüntüleyin ve depoya yıldız verin: {repo}',
  'socialShare.projectCopyText': 'RantAI Design ile oluşturuldu: {title}\n{url}\nRantAI Design deposu: {repo}',
  ...
  'brandEnrichment.body': "RantAI Design arka planda daha derin bir çıkarım çalıştırır, doğru design system skills paketini otomatik uygular ve bu sistemi yerinde günceller. Bu işlem 10-20 dakika sürebilir; çalışmaya devam edebilirsiniz.",
  ...
  'chat.activeFilePlaceholder': 'RantAI Design\'dan {file} dosyasını değiştirmesini isteyin...',
  ...
  'chat.mode.design.solves': 'RantAI Design’ın dosya üretmesini, workspace’i güncellemesini veya brief’i çok modlu deliverable’lara dönüştürmesini istediğinizde kullanın.',
  ...
  'preview.shareTextDefault': 'RantAI Design şablonu: {title}',
  ...
  'preview.errorBody': 'Örnek HTML\'i alınamadı. RantAI Design\'ın çalıştığından emin olup tekrar deneyin.',
  ...
  'designFiles.usefulInfoTip8': 'Yenilikler için X üzerinde RantAI Design hesabını takip edin.',
  ...
  'assistant.shareToOpenDesign': 'RantAI Design\'a paylaş',
  ...
  'pet.tabBuiltInHint': 'RantAI Design ile gelen seçili dostlar — birini seç ve sahiplen.',
  ...
  'pet.codexBundledTitle': 'RantAI Design ile birlikte gelir — indirme gerekmez.',
  ...
  'settings.projectLocationsDescription': 'Birden fazla RantAI Design proje klasörü içerebilen çalışma tabanları ekleyin. Yeni projeler seçilen tabanın içinde bir klasör olarak kaydedilir.',
  ...
  'settings.customInstructionsHint': 'RantAI Design\'ın her sohbette uyması gereken sabit talimatlar. Gerçekleri, tercihleri ve proje bağlamını bellek olarak kaydedin.',
  ...
  'settings.memoryStarterProjectDesc': 'RantAI Design v0.5 — sohbet odaklı tasarım editörü',
  ...
  'updater.availableBody': 'RantAI Design {version} mevcut. Yükleyici açılmadan önce indirilecek.',
  ...
  'updater.installerOpenBody': 'Yükleyici açık. Güncellemeyi tamamlayabilmeniz için RantAI Design kapatılıyor.',
  ...
  'updater.quitButton': 'RantAI Design’dan çık',
  'updater.quitFailedBody': 'Yükleyici açık, ancak RantAI Design kapatılamadı. Uygulamayı değiştirmeden önce RantAI Design’dan çıkın.',
  'updater.quitFailedTitle': 'Çıkılamadı',
  'updater.quitting': 'Çıkılıyor...',
  'updater.ready': 'Güncelleme hazır',
  'updater.readyGeneric': 'Yeni bir sürüm hazır. RantAI Design kapanıp yükleyiciyi açacak.',
  'updater.readyVersion': 'RantAI Design {version} hazır. RantAI Design kapanıp yükleyiciyi açacak.',
  ...
  'dsManager.createBody': 'RantAI Design\'a markanızı, ürününüzü, kodunuzu, varlıklarınızı ve tasarım referanslarınızı öğretin.',
  ...
  'settings.customInstructionsDesc': 'RantAI Design\'ın her sohbette izlediği sabit yönergeler. Bunlar kayıtlı bellekler değildir; gerçekler, tercihler ve proje bağlamı için Bellek\'i kullanın.',
  ...
  'onboarding.buildBody': 'RantAI Design markanı yeniden kullanılabilir bir tasarım sistemine dönüştürür ve oluşturduğun her şeyi markaya uygun ve tutarlı tutar.',
