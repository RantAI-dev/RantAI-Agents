...
export function WizardHero({ turns, streaming, error, onSend }: Props) {
  ...
  // ── In conversation: full-page chat (transcript fills the page, composer pinned) ──
  if (hasConversation) {
    return (
  ...
  return (
    <div className="mx-auto flex h-full w-full max-w-2xl flex-col items-center justify-center gap-6 px-6 py-8">
