...
export function ArtifactPanel({
  ...
  // the download. Two export options are surfaced — Word (.docx) and PDF
  // (.pdf). Both go through the server endpoint which runs the docx-js
  // script in the sandbox; PDF additionally pipes through soffice.
