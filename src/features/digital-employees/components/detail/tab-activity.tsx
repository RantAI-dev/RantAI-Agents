...
import { OnboardingChecklist, type OnboardingStatusData } from "./onboarding-checklist"
  ...
  return (
    <div className="flex-1 overflow-auto p-5 space-y-4">
      ...
      {employee.status === "ONBOARDING" && (
        <OnboardingChecklist employeeId={employee.id} initialStatus={initialOnboardingStatus} />
      )}
