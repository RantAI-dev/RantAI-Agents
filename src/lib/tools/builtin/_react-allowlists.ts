/**
 * React-artifact identifier allowlists for `validateReact`.
 *
 * Generated from the installed package versions:
 *   - lucide-react (5194 names — both canonical `Foo` and `FooIcon` aliases)
 *   - recharts (54 components)
 *
 * Regenerate by running, from repo root:
...
export const LUCIDE_NAMES: ReadonlySet<string> = new Set([
  "AArrowDown",
  "AArrowDownIcon",
  "AArrowUp",
  "AArrowUpIcon",
...
export const RECHARTS_NAMES: ReadonlySet<string> = new Set([
  "Area",
  "AreaChart",
  "Bar",
  "BarChart",
