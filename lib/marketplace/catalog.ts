...
// ─── Static Catalog (for seed script only) ─────────────────

/** @deprecated Use DB-backed getCatalogItems() instead. Kept for seed migration. */
export const STATIC_CATALOG: MarketplaceCatalogItem[] = [
  // ─── Productivity ───────────────────────────────────────
  {
    id: "mp-google-calendar",
    ...
    toolTemplate: {
      ...
      displayName: "Google Calendar",
      description: "Manage Google Calendar events: create, list, update, and delete events",
      parameters: { type: "object", properties: { action: { type: "string", enum: ["list", "create", "update", "delete"] }, title: { type: "string" }, startTime: { type: "string" }, endTime: { type: "string" }, eventId: { type: "string" } } },
      executionConfig: { url: "https://www.googleapis.com/calendar/v3/calendars/primary/events", method: "POST" },
    },
  },
  {
    id: "mp-notion",
    ...
    toolTemplate: {
      ...
      parameters: { type: "object", properties: { action: { type: "string", enum: ["search", "create_page", "update_page"] }, query: { type: "string" }, content: { type: "string" } } },
      executionConfig: { url: "https://api.notion.com/v1/search", method: "POST" },
    },
  },
  {
    id: "mp-todoist",
    ...
    toolTemplate: {
      name: "todoist",
      displayName: "Todoist",
      description: "Create, list, and complete tasks in Todoist",
      parameters: { type: "object", properties: { action: { type: "string", enum: ["list", "create", "complete", "delete"] }, content: { type: "string" }, projectId: { type: "string" } } },
      executionConfig: { url: "https://api.todoist.com/rest/v2/tasks", method: "POST" },
    },
  },
  {
    id: "mp-time-management-skill",
    name: "time-management",
    displayName: "Time Management",
    description: "Teach the agent time management and scheduling strategies",
    category: "Productivity",
    type: "skill",
    icon: "Clock",
    tags: ["productivity", "planning", "time"],
    skillTemplate: {
      name: "time-management",
      displayName: "Time Management",
      description: "Time management and scheduling strategies",
      content: "## Time Management Skill\n\nWhen the user asks about scheduling, planning, or time management:\n\n1. **Prioritize tasks** using the Eisenhower Matrix (urgent/important)\n2. **Suggest time blocks** for focused work (25-minute Pomodoro sessions)\n3. **Identify time wasters** and suggest alternatives\n4. **Create daily plans** with realistic time estimates\n5. **Recommend breaks** to maintain productivity\n\nAlways ask about deadlines and dependencies before creating a schedule.",
      category: "productivity",
      tags: ["productivity", "planning", "time"],
    },
  },
  ...
  // ─── Development ────────────────────────────────────────
  {
    ...
    toolTemplate: {
      name: "github_issues",
      displayName: "GitHub Issues",
      description: "Manage GitHub issues: create, search, list, and comment",
      parameters: { type: "object", properties: { action: { type: "string", enum: ["list", "create", "comment", "close"] }, repo: { type: "string" }, title: { type: "string" }, body: { type: "string" } } },
      executionConfig: { url: "https://api.github.com/repos/{owner}/{repo}/issues", method: "POST" },
    },
  },
  {
    id: "mp-jira",
    ...
    toolTemplate: {
      ...
      parameters: { type: "object", properties: { action: { type: "string", enum: ["search", "create", "update", "transition"] }, projectKey: { type: "string" }, summary: { type: "string" }, description: { type: "string" } } },
      executionConfig: { url: "https://your-domain.atlassian.net/rest/api/3/issue", method: "POST" },
    },
  },
  {
    id: "mp-linear",
    ...
    toolTemplate: {
      ...
      parameters: { type: "object", properties: { action: { type: "string", enum: ["list", "create", "update"] }, title: { type: "string" }, description: { type: "string" }, teamId: { type: "string" } } },
      executionConfig: { url: "https://api.linear.app/graphql", method: "POST" },
    },
  },
  {
    id: "mp-code-review-skill",
    name: "code-review",
    displayName: "Code Review",
    description: "Teach the agent thorough code review practices",
    category: "Development",
    type: "skill",
    icon: "Code",
  ...
  // ─── Communication ──────────────────────────────────────
  {
    ...
    toolTemplate: {
      ...
      parameters: { type: "object", properties: { action: { type: "string", enum: ["send_message", "list_channels", "search"] }, channel: { type: "string" }, text: { type: "string" } } },
      executionConfig: { url: "https://slack.com/api/chat.postMessage", method: "POST" },
    },
  },
  {
    id: "mp-discord",
    ...
    toolTemplate: {
      ...
      parameters: { type: "object", properties: { content: { type: "string" }, username: { type: "string" } } },
      executionConfig: { url: "https://discord.com/api/webhooks/{webhook_id}/{webhook_token}", method: "POST" },
    },
  },
  {
    id: "mp-email-drafter-skill",
    name: "email-drafter",
    displayName: "Email Drafter",
    description: "Craft professional emails with proper tone and structure",
    category: "Communication",
    type: "skill",
    icon: "Mail",
  ...
  // ─── Data & Analytics ───────────────────────────────────
  {
    ...
    toolTemplate: {
      ...
      parameters: { type: "object", properties: { action: { type: "string", enum: ["read", "write", "append"] }, spreadsheetId: { type: "string" }, range: { type: "string" }, values: { type: "array" } } },
      executionConfig: { url: "https://sheets.googleapis.com/v4/spreadsheets", method: "POST" },
    },
  },
  {
    id: "mp-airtable",
    ...
    toolTemplate: {
      name: "airtable_api",
      displayName: "Airtable",
      description: "Query, create, and update records in Airtable",
      parameters: { type: "object", properties: { action: { type: "string", enum: ["list", "create", "update", "delete"] }, baseId: { type: "string" }, tableName: { type: "string" }, fields: { type: "object" } } },
      executionConfig: { url: "https://api.airtable.com/v0/{baseId}/{tableName}", method: "POST" },
    },
  },
  {
    id: "mp-data-analysis-skill",
    name: "data-analysis",
    displayName: "Data Analysis",
    description: "Guide structured data analysis and visualization recommendations",
    category: "Data",
    type: "skill",
    icon: "BarChart",
    ...
    skillTemplate: {
      name: "data-analysis",
      displayName: "Data Analysis",
      description: "Structured data analysis and visualization guidance",
  ...
  // ─── AI & Writing ───────────────────────────────────────
  {
    id: "mp-technical-writer-skill",
    name: "technical-writer",
    displayName: "Technical Writer",
    description: "Write clear technical documentation and API docs",
    category: "AI & Writing",
    type: "skill",
    icon: "FileText",
  ...
  // ─── Customer Support ───────────────────────────────────
  {
    ...
    toolTemplate: {
      name: "zendesk_api",
      displayName: "Zendesk",
      description: "Create, search, and update Zendesk support tickets",
      parameters: { type: "object", properties: { action: { type: "string", enum: ["create", "search", "update", "comment"] }, subject: { type: "string" }, description: { type: "string" }, ticketId: { type: "string" } } },
      executionConfig: { url: "https://your-domain.zendesk.com/api/v2/tickets", method: "POST" },
    },
  },
  {
    id: "mp-customer-empathy-skill",
    name: "customer-empathy",
    displayName: "Customer Empathy",
    description: "Handle customer interactions with empathy and professionalism",
    category: "Customer Support",
    type: "skill",
    icon: "Heart",
    tags: ["customer-service", "empathy", "support"],
    skillTemplate: {
      name: "customer-empathy",
      displayName: "Customer Empathy",
      description: "Empathetic customer interaction framework",
      content: "## Customer Empathy Skill\n\nWhen interacting with customers:\n\n### Response Framework (HEAR)\n1. **Hear**: Acknowledge the specific issue\n2. **Empathize**: Show understanding of their frustration\n3. **Apologize**: Take responsibility where appropriate\n4. **Resolve**: Provide clear next steps\n\n### Tone Rules\n- Never blame the customer\n- Avoid jargon and technical terms\n- Use \"I\" and \"we\" (not \"the system\" or \"the policy\")\n- Match urgency to the customer's emotional state\n\n### De-escalation\n- Validate their feelings first\n- Offer options, not ultimatums\n- Set realistic expectations for resolution time\n- Follow up on promises made\n\n### Angry Customer Template\n\"I understand how frustrating [specific issue] must be. I'm sorry you're experiencing this. Let me [specific action] right away. Here's what will happen next: [clear timeline].\"",
      category: "support",
  ...
  // ─── Utilities ──────────────────────────────────────────
  {
    ...
    toolTemplate: {
      ...
      displayName: "Weather API",
      description: "Get current weather and forecasts for any location",
      parameters: { type: "object", properties: { location: { type: "string", description: "City name or coordinates" }, units: { type: "string", enum: ["metric", "imperial"], description: "Temperature units" } }, required: ["location"] },
      executionConfig: { url: "https://api.openweathermap.org/data/2.5/weather", method: "GET" },
    },
  },
  {
    id: "mp-qr-code",
    ...
    toolTemplate: {
      ...
      parameters: { type: "object", properties: { data: { type: "string", description: "Text or URL to encode" }, size: { type: "number", description: "Image size in pixels" } }, required: ["data"] },
      executionConfig: { url: "https://api.qrserver.com/v1/create-qr-code/", method: "GET" },
    },
  },
]
